      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 mt-5">
            ...
            <p>
              Sitemizde verilen tüm servisler firmamıza aittir ve firmamız
            ...
            <p>
              Üyelik veya sitemiz üzerindeki çeşitli form ve anketlerin
              ...
              veya e-posta adresleri gibi) firmamız tarafından işin doğası
            ...
            <p>
              Firmamız üzerinden veya e-posta ile gerçekleştirilen onay
              sürecinde, üyelerimiz tarafından firmamıza elektronik ortamdan
              iletilen kişisel bilgiler, üyelerimiz ile yaptığımız "Kullanıcı
              Sözleşmesi" ile belirlenen amaçlar ve kapsam dışında üçüncü
            ...
            <p>
              ...
              için, firmamız, üyelerinin IP adresini kaydetmekte ve bunu
            ...
            <p>
              ...
              bilgiler veya kullanıcı tarafından sağlanan bilgiler veya Firmamız
              üzerinden yapılan işlemlerle ilgili bilgiler; Firmamız ve
              işbirliği içinde olduğu kişiler tarafından, "Üyelik Sözleşmesi"
              ile belirlenen amaçlar ve kapsam dışında da, üyelerimizin kimliği
              ifşa edilmeden çeşitli istatistiksel değerlendirmeler, veri tabanı
            ...
            <br />
            <p>
              <b>KREDİ KARTI GÜVENLİĞİ</b>
            </p>

            <p>
              Firmamız, alışveriş sitelerimizden alışveriş yapan kredi kartı
              sahiplerinin güvenliğini ilk plânda tutmaktadır. Kredi kartı
            ...
            <p>
              ...
              firmanın bütün telefon/adres bilgilerini not edin. Eğer
            ...
            <p>
              ...
              taşımamaktadır. Firmamıza ait sitede yayınlanan reklâmlar,
              reklâmcılık yapan iş ortaklarımız aracılığı ile kullanıcılarımıza
              dağıtılır. İş bu sözleşmedeki Gizlilik Politikası Prensipleri,
              sadece firmamızın kullanımına ilişkindir, üçüncü taraf web
              sitelerini kapsamaz.
            </p>
            ...
            <p>
              Aşağıda belirtilen sınırlı hâllerde firmamız, işbu "Gizlilik
            ...
            <p>
              ...
              kurallarının getirdiği zorunluluklara uymak.
            </p>
            <p>
              2.Firmamızın kullanıcılarla akdettiği "Üyelik Sözleşmesi"'nin ve
              diğer sözleşmelerin gereklerini yerine getirmek ve bunları
              uygulamaya koymak amacıyla.
            </p>
            <p>
              3.Yetkili idari ve adli otorite tarafından usulüne göre yürütülen
            ...
            <p>
              ...
              vermenin gerekli olduğu hâllerdir.
            </p>

            <br />
            <p>
              <b>E-POSTA GÜVENLİĞİ</b>
            </p>

            <p>
              Firmamızın Müşteri Hizmetleri'ne, herhangi bir siparişinizle
            ...
            <p>
              Firmamız, firmamızı ziyaret eden kullanıcılar ve kullanıcıların
            ...
            <p>
              ...
              olarak reklâm ve içerik üretilmesine yardımcı olur. Teknik
            ...
            <p>
              ...
              için info@wease.io adresine email gönderebilirsiniz. Firmamız' a
              ait aşağıdaki iletişim bilgilerinden ulaşabilirsiniz.
            </p>
            <p></p>
            <br />
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Kozyatağı Mh. Sıtmapınarı Sk. N.3 IMPA Plaza
                    Kadıköy/İstanbul
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>0216 573 45 27</td>
                </tr>
                <tr>
                  <td>
                    <b>Fax</b>
                  </td>
                  <td>0216 573 45 28</td>
                </tr>
              </tbody>
            </table>
          </div>
